...
![Boot instance from image and attach non-bootable volume](3.png)
...
![install interface](4.png)

按照正常流程安装系统即可，在分区设置时，可以只设置根分区即可，如图:

![install interface](5.png)
