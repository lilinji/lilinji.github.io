...
date: 2025-12-29T11:00:32+08:00
draft: false
tags:
  - GPU
  - LLM
...
![](images/image-20250223214308430.png)
...
![image-20250223223638135](images/image-20250223223638135.png)

然后，我们打开这个地址，点击左侧的 `Connect` 按钮，即可连接我们刚写的服务。然后我们切换到 `Tools` 栏中，点击 `List Tools` 按钮即可看到我们刚写的工具，我们就可以开始进行调试啦。

![image-20250223224052795](images/image-20250223224052795.png)
...
![image-20250227221154638](images/image-20250227221154638.png)

我们点击 `Developer` 菜单，然后点击 `Edit Config` 按钮打开 Claude 桌面端的配置文件 `claude_desktop_config.json`

![image-20250227221302174](images/image-20250227221302174.png)
...
![](images/image-20250227221911231.png)

![image-20250227221921036](images/image-20250227221921036.png)
...
![mcp001](images/mcp001-1740666812436-2.gif)
...
![image-20250301231332749](images/image-20250301231332749.png)

接着我们在 VsCode 中安装 cline 插件，当安装完插件后，我们配置一下我们的 deepseek 的 api key。接着，我们点击右上角的 `MCP Server` 按钮打开 mcp server 列表。

![image-20250301232248034](images/image-20250301232248034.png)

然后切换到 `Installed` Tab 点击 `Configure MCP Servers` 按钮来编辑自定义的 mcp 服务器。

![image-20250301232417966](images/image-20250301232417966.png)
...
![image-20250301232809433](images/image-20250301232809433.png)

然后，我们就打开输入框，来输入我们的要写的文章的内容：

![image-20250301233421292](images/image-20250301233421292.png)

我们可以看到，他正确的调用了我们的工具

![image-20250301233726301](images/image-20250301233726301.png)

最后，就是可以看到生成的文章啦。

![image-20250301234532249](images/image-20250301234532249.png)
...
![image-20250406152518223](images/image-20250406152518223.png)

当然，我们也可以使用 `mcp dev sse_web_search.py` 的方式来测试。这里要注意的是，`Transport Type` 需要改成 `SSE`，然后下面填写我们的本地服务地址。

![image-20250406153106098](images/image-20250406153106098.png)
...
![image-20250406153655185](images/image-20250406153655185.png)
...
![image-20250406154115438](images/image-20250406154115438.png)

在高级设置中，为了方便调试，我启动了日志功能。

![image-20250406154228341](images/image-20250406154228341.png)

设置完成后，点创建即可。他就跳转到代码编辑部分，然后我们把之前的代码复制进去即可。

![image-20250406154441634](images/image-20250406154441634.png)
...
![image-20250406155803071](images/image-20250406155803071.png)

到这里，我们的 MCP 服务就被部署到了云端，我们就可以在任何地方直接来使用它了。

比如，在 `Cherry-Studio` 中，我们可以这样来设置：

![image-20250406160152782](images/image-20250406160152782.png)

在 `Cline` 中：

![image-20250406160709759](images/image-20250406160709759.png)

在 `Cursor` 中：

![image-20250406161055717](images/image-20250406161055717.png)
