...
![ceph rbd mirror](ceph-rbd-mirror.png)
...
![ceph rbd mirror inside](ceph-rbd-mirror-inside.png)
...
![openstack multisite ceph no regions](openstack-multisite-ceph-no-regions.png)
