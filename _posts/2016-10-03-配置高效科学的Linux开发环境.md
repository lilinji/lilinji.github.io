...
![tmux](/img/posts/配置高效科学的Linux开发环境/tmux.jpg)
...
![vim-mark-demo](/img/posts/配置高效科学的Linux开发环境/vim-mark.jpg)
...
![vim-taglist](/img/posts/配置高效科学的Linux开发环境/vim-taglist.jpg)
...
![vim-nerdcommenter](/img/posts/配置高效科学的Linux开发环境/vim-comment.jpg)

#### 7. nerdtree

项目文件浏览，使用<Leader> f打开:

![vim-nerdtree](/img/posts/配置高效科学的Linux开发环境/vim-nerdtree.jpg)

#### 8. YouCompleteMe

Vim自动补全插件，能够集成ctags以及jedi等，效果如图:

![ycm](/img/posts/配置高效科学的Linux开发环境/vim-ycm.jpg)

![ycm](/img/posts/配置高效科学的Linux开发环境/vim-ycm-2.jpg)

#### 9. ctrlp

文件搜索功能，能够在vim上快速搜索文件并打开。在命令行模式下输入`ctrl+p`触发:

![ctrlp](/img/posts/配置高效科学的Linux开发环境/vim-ctrlp.jpg)
...
![easymotion](/img/posts/配置高效科学的Linux开发环境/vim-easymotion.jpg)
...
![vim paste](/img/posts/配置高效科学的Linux开发环境/vim-paste.jpg)
...
![zsh-syntax](/img/posts/配置高效科学的Linux开发环境/zsh-syntax.jpg)
...
![iterm](/img/posts/配置高效科学的Linux开发环境/iterm.jpg)
...
![tig-demo](/img/posts/配置高效科学的Linux开发环境/tig-demo.jpg)
...
![fzf](/img/posts/配置高效科学的Linux开发环境/fzf.jpg)
...
![git-diff](/img/posts/配置高效科学的Linux开发环境/git-diff.jpg)
...
![fpp-demo](/img/posts/配置高效科学的Linux开发环境/fpp-demo.jpg)
...
![htop](/img/posts/配置高效科学的Linux开发环境/htop.jpg)
...
![axel](/img/posts/配置高效科学的Linux开发环境/axel.jpg)
