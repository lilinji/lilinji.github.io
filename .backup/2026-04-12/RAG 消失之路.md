---
title: "RAG 消失之路"
source: "https://wqw547243068.github.io/no_rag"
author:
...
tags:
  - "clippings"
migrated: "2026-04-12T00:08:31.994Z"
---
- [RAG 消失之路](#rag-消失之路)
	- [总结](#总结)
		- [新结构](#新结构)
		- [M-FLOW 倒锥图路由](#m-flow-倒锥图路由)
		- [免嵌入 Embedding Free](#免嵌入-embedding-free)
		- [文件检索](#文件检索)
		- [树状推理](#树状推理)
		- [PageIndex](#pageindex)
		- [无检索](#无检索)
		- [【2026-2-27】阿里 Sirchmunk](#2026-2-27阿里-sirchmunk)
- [结束](#结束)
...
- 2) 2) pip安装：使用pip install m\_flow命令，并配置LLM API密钥。该方案在多项Benchmark测试中表现优异。
...
[![image](https://github.com/user-attachments/assets/8a760bae-7289-449b-9d49-cc702bc04d36)](https://github.com/user-attachments/assets/8a760bae-7289-449b-9d49-cc702bc04d36)
...
- [![](https://pica.zhimg.com/v2-3164ce17e78ef06d071aa1ed10128240_1440w.jpg)](https://pica.zhimg.com/v2-3164ce17e78ef06d071aa1ed10128240_1440w.jpg)
